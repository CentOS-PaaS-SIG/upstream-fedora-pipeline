...
This repository holds all the code for the Jenkins pipeline workflow.<br><br>
...
The Koji Build stage of the comes from the [pull_old_task.sh script](https://github.com/CentOS-PaaS-SIG/upstream-fedora-pipeline/tree/master/config/Dockerfiles/fedoraci-runner/rpmbuild/pull_old_task.sh).
...
For the pr pipeline, this stage submits a Koji scratch build for the change using [koji_build_pr.sh script](https://github.com/CentOS-PaaS-SIG/upstream-fedora-pipeline/tree/master/config/Dockerfiles/fedoraci-runner/rpmbuild/koji_build_pr.sh)
...
The image customize stage of the pipeline comes from the [virt-customize script](https://github.com/CentOS-PaaS-SIG/upstream-fedora-pipeline/tree/master/config/Dockerfiles/fedoraci-runner/virt-customize/virt-customize.sh).
...
The rpm verify stage comes from the [verify-rpm script](https://github.com/CentOS-PaaS-SIG/upstream-fedora-pipeline/blob/master/config/fedoraci-runner/Dockerfiles/package-test/verify-rpm.sh).
...
The package test stage comes from the [package-test script](https://github.com/CentOS-PaaS-SIG/upstream-fedora-pipeline/tree/master/config/Dockerfiles/fedoraci-runner/package-test/package-test.sh).
...
The pull request must be opened against this repo.
...
If a developer wishes to retrigger the stage pipeline from the pull request, he/she can either add a commit, comment [test] if the pull request is to this repo.<br>
...
Due to the potential of the OpenShift hosted images being changed, the merge job will also promote the respective stage images to stable when the [merge] command is used.
